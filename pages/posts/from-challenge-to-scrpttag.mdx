...
import Codepen from '../../components/Article/elements/Codepen'
import Author from '../../components/Article/elements/Author'

![scrpttag animated logo](/scrpttag.gif)
...
<Codepen title="Hold #28ComponentsOfFebruaryDay3" slugHash="LYbpjRp" />
...
<Codepen title="Wait, it's loading #28ComponentsOfFebruaryDay12" slugHash="PobWwar" />
...
<Codepen title="Switch Dark #28ComponentsOfFebruaryDay4" slugHash="wvoMGBE" />
...
<Codepen title="The Scrpttag has You #28ComponentsOfFebruaryDay28" slugHash="abBYLjX" />
...
export default ({ children }) => (
  <Article
    description="At some point we need to step out from the usual and challenge ourselves. You must have heard about different kind of code challenges like #100DaysofCode, #30DaysofCode or #100DaysofHacking."
    image="/scrpttag.gif"
    title="From Challenge to Scrpttag | Scrpttag"
    url="/posts/from-challenge-to-scrpttag"
  >
    {children}
  </Article>
)